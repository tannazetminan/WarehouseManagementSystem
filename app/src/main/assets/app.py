...
def retrieve_all_products():
    ...
    for product in products:
        ...
        product['image_url'] = request.host_url + product['image_url'] #Append the full image URL using request.host_url
...
def retrieve_single_product(product_id):
    try:
        ...
        if product:
            ...
            product['image_url'] = request.host_url + product['image_url']
